...
Moderation for online communities is terrible. It’s a hard job, it doesn’t scale with community growth, and it requires imparting a “culture” on people, which is still an art and not a science. This is an important problem to solve, as good communities make life worth living - and fostering the right types of online communities can engender valuable intellectual output.
...
Instead of trying to write out explicit rules, an exercise that is doomed to fail, we select individual representatives. On the internet, moderators get selected who can have broad powers to enforce norms. Real world analogue: Judges/juries can determine whether something is in violation of explicit law - “no murdering and you murdered that guy” - or implicit law - “your statements, while not technically lies, are deceptive enough to count as fraud”. This is the distinction between statutory law and common law.
...
The selection task is a problem akin to the problem of governance, democracy, etc. By what method do we select our rulers? There’s something poetic about selecting a ruler because they most embody the culture.
...
- The model could be retrained slowly, in specific windows, for example weekly on Sundays, with a staging/deploy model. 

Decision Points

- Is Semi-Supervised Learning Better than fully Supervised?
- What is the distribution of comments in a binary space?
...
Continue over time to expand 

- Random audits should still be conducted to prevent value drift.
Challenges
